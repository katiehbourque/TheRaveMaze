...
import edu.wm.cs.cs301.abigaildanielandkatiebourque.UI.PlayManuallyActivity;
    ...
    public boolean keyDown(UserInput key, int value) {
        ...
        switch (key) {
            ...
            case Up: // move forward //k
                ...
                break;
            case Left: // turn left  //h
                rotate(1);
                break;
            case Right: // turn right  //l
                rotate(-1);
                break;
            case Down: // move backward  //j
                walk(-1);
                // check termination, did we leave the maze?
                if (isOutside(px,py)) {
                    //control.switchFromPlayingToWinning(0, 0);
