...
public class FirstPersonView {
     ...
     */
    public void draw(MazePanel mazePanel, int x, int y, int walkStep, int ang) {
    ...
    private void drawBackground() {
       ...
       mazePanel.mazebackground(0,0, viewWidth, viewHeight);
        //mazePanel.setColor(0, 0, 0);
        //mazePanel.fillRect(0, 0, viewWidth, viewHeight/2);
        // grey rectangle in lower half of screen
       // mazePanel.setColor(66, 64, 64);
      //  mazePanel.fillRect(0, viewHeight/2, viewWidth, viewHeight/2);
    }
    /**
    ...
    private void drawWall(Wall wall) {
        ...
        mazePanel.setColor(wall.getColor()[0], wall.getColor()[1], wall.getColor()[2]);
